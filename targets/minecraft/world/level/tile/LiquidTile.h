...
public:
    static const std::string TEXTURE_LAVA_STILL;
    static const std::string TEXTURE_WATER_STILL;
    static const std::string TEXTURE_WATER_FLOW;
    static const std::string TEXTURE_LAVA_FLOW;
